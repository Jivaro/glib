...
G_GNUC_INTERNAL void    g_value_c_deinit        (void); /* sync with gvalue.c */
...
G_GNUC_INTERNAL void    g_param_type_deinit     (void); /* sync with gparam.c */
...
G_GNUC_INTERNAL void    g_object_type_deinit    (void); /* sync with gobject.c */
G_GNUC_INTERNAL void    g_param_spec_types_init (void); /* sync with gparamspecs.c */
G_GNUC_INTERNAL void    g_param_spec_types_deinit (void); /* sync with gparamspecs.c */
...
G_GNUC_INTERNAL void    g_signal_deinit         (void); /* sync with gsignal.c */
